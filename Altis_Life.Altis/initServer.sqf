...
_try = _startObject1 modeltoworld [0,_numb,0];
...
_wallNumber = 40;
_wirenumb = _wallnumber;
_try = _startObject modeltoworld [0,_numb,0];
_wallDir = getdir _startObject1  + (90);
_wallInterval = 4; 
_tower2 setdir 180;
...
_light setdir _lightdir;
_try = _startObject modeltoworld [3,_numb,0];
_wallDir = getdir _startObject1  + (90);
_wallInterval = 4;
_tower3 setdir 270;
...
_light setdir _lightdir;
_try = _startObject modeltoworld [-0.8,_numb,0];////
_wallDir = getdir _startObject1  + (90);
_wallInterval = 4; 
_tower4 setdir 360;
...
_gatepos = _startObject modeltoworld [0,88,0];	
...
_gatepos1 = _startObject modeltoworld [0,98,0];	
...
//////////////////end
_try = _startObject modeltoworld [50,-5,0];////
_startobject = createVehicle ["land_helipadempty_f", _try ,[], 0, ""];
_startobject setdir 270;
_wallNumber = 42;
_wirenumb = _wallnumber;
...
_housepos = _hole modeltoworld [30,30,-1.5];	
...
_housepos1 = _hole modeltoworld [30,50,-1.5];	
...
_housepos2 = _hole modeltoworld [30,70,-1.5];	
...
_housepos3 = _hole modeltoworld [30,90,-1.5];	
...
_housepos4 = _hole modeltoworld [70,30,-1.5];	
...
_housepos5 = _hole modeltoworld [70,50,-1.5];	
...
_housepos6 = _hole modeltoworld [70,70,-1.5];
...
_housepos7= _hole modeltoworld [70,90,-1.5];	
...
_housepos8= _hole modeltoworld [130,90,-1.5];	
...
_housepos9= _hole modeltoworld [130,40,-1.5];	
...
_offpos1 = _secondgate1 modeltoworld [-50,-25,-1.5];	
...
_offpos2 = _secondgate1 modeltoworld [-30,-25,-1.5];	
...
_offpos3 = _secondgate1 modeltoworld [-10,-25,-1.5];	
...
////guard towers////
_guardpos = _maingate1 modeltoworld [-8,3,-1.5];	
...
_guardpos1 = _maingate1 modeltoworld [18,3,-1.5];	
...
_guardpos2 = _secondgate1 modeltoworld [-8,-5,-1.5];	
...
_guardpos3 = _secondgate1 modeltoworld [18,-5,-1.5];	
...
////Sign///
_signpos = _maingate1 modeltoworld [-8,0,-2];	
...
_signpos1 = _maingate1 modeltoworld [18,0,-2];	
...
///light prisoners
_lightpos = _hole modeltoworld [85,60,-2];	
_light = createVehicle ["Land_LampHalogen_F", _lightpos ,[], 0, ""];	
_light setdir 0;
_light setVectorUp vectorUp _tower1;
