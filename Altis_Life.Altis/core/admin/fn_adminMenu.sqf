...
switch(__GETC__(life_adminlevel)) do
{
	...
	case 3: {ctrlShow [2907,false];ctrlShow [2908,false];ctrlShow [2909,false];ctrlShow [2910,false];ctrlShow [2911,false];ctrlShow [2912,false];};
	case 4: {ctrlShow [2911,false];ctrlShow [2912,false];};
	case 5: {ctrlShow [2912,false];};
};
