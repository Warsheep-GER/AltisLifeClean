...
switch(true) do
{
	...
	{
		[[3,"Interpol hat eine internationale Drogenbande ausgehoben!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[3,"Öltanker gesunken!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[3,"China baut World-China-Center!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[3,"Anleger verlieren Vertrauen in Dollar!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[3,"Neue synthetische Droge überschwemmt Drogenmarkt!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	{
		[[3,"China entdeckt Schildkröten als neue Medizin! Tierschützer sind besorgt!"],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
