...
switch (_var) do
{
	...
	case "life_inv_radar40": {(localize "STR_Item_Radar40")};
	case "life_inv_radar120": {(localize "STR_Item_Radar120")};
	...
	case "license_civ_kavala": {(localize "STR_License_Kavala")};
	case "license_civ_pyros": {(localize "STR_License_Pyros")};
	case "license_civ_sofia": {(localize "STR_License_Sofia")};
	case "license_civ_reb1": {(localize "STR_License_Reb1")};
	case "license_civ_reb2": {(localize "STR_License_Reb2")};
	case "license_civ_reb3": {(localize "STR_License_Reb3")};
	case "license_civ_reb4": {(localize "STR_License_Reb4")};
	case "license_med_air": {(localize "STR_License_Pilot")};
	case "license_med_bund": {(localize "STR_License_Bund")};
	...
	case "license_cop_bund": {(localize "STR_License_Bund")};
};
