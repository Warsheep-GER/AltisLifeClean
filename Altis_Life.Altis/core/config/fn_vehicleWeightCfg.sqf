...
switch (_className) do
{
	...
	case "C_SUV_01_F": {50};
	case "I_MRAP_03_hmg_F": {48};
	case "O_MRAP_02_hmg_F": {50};
	case "B_MRAP_01_hmg_F": {55};
	case "I_MRAP_03_F": {58};
	case "O_MRAP_02_F": {60};
	case "B_MRAP_01_F": {65};
	...
	case "B_Heli_Attack_01_F": {300};
	case "B_Truck_01_transport_F": {325};
	case "O_Truck_02_transport_F": {325};
	case "B_Truck_01_ammo_F": {325};
	case "C_Van_01_fuel_F": {400};
	case "B_Truck_01_fuel_F": {425};
	case "O_Truck_02_fuel_F": {450};
