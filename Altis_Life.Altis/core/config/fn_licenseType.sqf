...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "kavala": {_var = "license_civ_kavala"};
			case "pyros": {_var = "license_civ_pyros"};
			case "sofia": {_var = "license_civ_sofia"};
			case "reb1": {_var = "license_civ_reb1"};
			case "reb2": {_var = "license_civ_reb2"};
			case "reb3": {_var = "license_civ_reb3"};
			case "reb4": {_var = "license_civ_reb4"};
			case "bundc": {_var = "license_cop_bund"};
			case "bundm": {_var = "license_med_bund"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_kavala": {_var = "kavala"};
			case "license_civ_pyros": {_var = "pyros"};
			case "license_civ_sofia": {_var = "sofia"};
			case "license_civ_reb1": {_var = "reb1"};
			case "license_civ_reb2": {_var = "reb2"};
			case "license_civ_reb3": {_var = "reb3"};
			case "license_civ_reb4": {_var = "reb4"};
			case "license_cop_bund": {_var = "bundc"};
			case "license_med_bund": {_var = "bundm"};
			default {_var = ""};
		};
	};
};
