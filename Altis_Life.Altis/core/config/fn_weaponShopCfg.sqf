			...
			default
			{
				["Hauptmeister Ausrüstung",
					[
						...
						["6Rnd_GreenSignal_F",nil,500],
						["6Rnd_RedSignal_F",nil,500],
						["arifle_Katiba_F",nil,150],
						["arifle_Katiba_ARCO_F",nil,150],
						["arifle_Katiba_ACO_pointer_F",nil,150],
						["30Rnd_65x39_caseless_green",nil,500],
						["srifle_EBR_F",nil,50000],
						["srifle_EBR_ACO_F",nil,100000],
						["srifle_EBR_ARCO_pointer_F",nil,100000],
						["srifle_EBR_MRCO_pointer_F",nil,100000],
						["20Rnd_762x51_Mag",nil,500],
						["HandGrenade_Stone","Flashbang",10000]
					]
				];
